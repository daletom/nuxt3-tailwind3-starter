...
<template>
  <div class="relative overflow-hidden bg-white">
        ...
        <main class="px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div class="sm:text-center lg:text-left">
            <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
              ...
              {{ ' ' }}
              <span class="block text-5xl text-orange-600 xl:inline">Three Industry Examples</span>
            </h1>
            ...
            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              ...
              <div class="mt-3 sm:mt-0 sm:ml-3">
                <a href="/" class="flex items-center justify-center w-full px-8 py-3 text-base font-medium text-indigo-700 bg-indigo-100 border border-transparent rounded-md hover:bg-indigo-200 md:py-4 md:text-lg md:px-10"> Don't Want Javascript? </a>
              </div>
            </div>
          </div>
        </main>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="object-cover w-full h-56 sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://www.springboard.com/blog/wp-content/uploads/2019/08/sb-blog-java.png" alt="" />
    </div>
  </div>
  <!-- Sections -->
    ...
    <div class="relative mx-auto max-w-7xl">
      <div class="text-center">
        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Video Demos in Javascript</h2>
        <p class="max-w-2xl mx-auto mt-3 text-xl text-gray-500 sm:mt-4">These are a list of some demos we have made using imgix Video in Javascript.</p>
      </div>
